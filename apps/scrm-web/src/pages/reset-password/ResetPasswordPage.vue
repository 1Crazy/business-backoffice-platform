  ...
  <div class="reset-shell">
    <section class="reset-panel">
      ...
      <div class="panel-head">
        <div class="panel-title">设置新的 SCRM 密码</div>
      ...
      <el-form ref="formRef" :model="form" :rules="rules" label-position="top" require-asterisk-position="right" status-icon @submit.prevent="handleSubmit">
        ...
        <el-button type="primary" class="submit-button" :loading="submitting" @click="handleSubmit">重置密码</el-button>
      </el-form>
    </section>
  </div>
</template>
...
.reset-panel { width: min(100%, 520px); display: grid; gap: 18px; padding: 28px; border-radius: 24px; border: 1px solid rgba(15, 23, 42, 0.08); background: rgba(255, 255, 255, 0.96); box-shadow: 0 24px 48px rgba(15, 23, 42, 0.08); }
...
.panel-copy { color: var(--app-text-secondary); font-size: 13px; line-height: 1.7; }
